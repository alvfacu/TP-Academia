    ...
    public class ComisionAdapter: Adapter
    {
        public List<Comision> GetAll()
        {
            ...
            try
            {
                ...
                SqlCommand cmdComisiones = new SqlCommand("SELECT com.id_comision as idcom, com.desc_comision as descom, com.anio_especialidad as anio, com.id_plan as idplan, p.desc_plan as descplan FROM comisiones com INNER JOIN planes p ON p.id_plan = com.id_plan", sqlConn);
                ...
                while (drComisiones.Read())
                {
                    ...
                    com.ID = (int)drComisiones["idcom"];
                    com.Descripcion = (string)drComisiones["descom"];
                    com.AnioEspecialidad = (int)drComisiones["anio"];
                    com.IDPlan = (int)drComisiones["idplan"];
                    com.DescPlan = (string)drComisiones["descplan"];
        ...
        public List<Comision> GetAllXPlan(int plan)
        {
            ...
            try
            {
                ...
                SqlCommand cmdComisiones = new SqlCommand("SELECT com.id_comision as idcom, com.desc_comision as descom, com.anio_especialidad as anio, com.id_plan as idplan, p.desc_plan as descplan FROM comisiones com INNER JOIN planes p ON p.id_plan = com.id_plan WHERE com.id_plan=@plan", sqlConn);
                cmdComisiones.Parameters.Add("@plan", SqlDbType.Int).Value = plan;
