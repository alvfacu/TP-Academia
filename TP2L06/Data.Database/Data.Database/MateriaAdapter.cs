    ...
    public class MateriaAdapter: Adapter
    {
        public List<Materia> GetAll()
        {
            ...
            try
            {
                ...
                SqlCommand cmdMaterias = new SqlCommand("SELECT * FROM materias INNER JOIN planes ON planes.id_plan = materias.id_plan", sqlConn);
                ...
                while (drMaterias.Read())
                {
                    ...
                    mat.Desc_Plan = (string)drMaterias["desc_plan"];
        ...
        public object GetAllXPlan(int p)
        {
            ...
            try
            {
                ...
                SqlCommand cmdMaterias = new SqlCommand("SELECT * FROM materias INNER JOIN planes ON planes.id_plan = materias.id_plan WHERE materias.id_plan = @id", sqlConn);
                cmdMaterias.Parameters.Add("@id", SqlDbType.Int).Value = p;
                SqlDataReader drMaterias = cmdMaterias.ExecuteReader();
