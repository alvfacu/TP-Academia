...
namespace UI.Desktop
{
    public partial class Cursos : Form
    {
        ...
        public void Listar()
        {
            ...
            if (Login.UsuarioLogueado.Per.TipoPersona != Business.Entities.Personas.TiposPersonas.Administrador)
            {
                this.dgvCursos.DataSource = new CursoLogic().GetAllXPlan(Login.UsuarioLogueado.Per.IDPlan);
            }
            else
            {
        ...
        {
            ReporteCursos.ReporteCursos formReportes = new ReporteCursos.ReporteCursos();
            formReportes.Show();
        }
