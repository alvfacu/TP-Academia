...
<asp:ValidationSummary ID="ResumenValidaciones" ForeColor=Red runat="server" 
        ...
        DisplayMode="BulletList" ShowSummary="true" Width="435px" /> 
...
<br />
    ...
    <asp:RequiredFieldValidator ID="DescripcionRequerida" runat="server" ControlToValidate="descripcionTextBox"  
       ErrorMessage='Se requiere alguna descripción' EnableClientScript="true" SetFocusOnError="true" Text="*" ForeColor=Red></asp:RequiredFieldValidator>
       <br />
       <br />
</div>
</asp:Panel>
